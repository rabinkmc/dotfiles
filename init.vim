...
autocmd FileType tex nnoremap <F8> :VimtexTocToggle<Enter>
nnoremap <leader>lt :call<Space>vimtex#fzf#run()<cr>
...
inoremap <silent><expr> <TAB>
      ...
      \ coc#refresh()
inoremap <expr><A-TAB> pumvisible() ? "\<A-p>" : "\<A-h>"
...
nnoremap <leader>go :!g++<Space>"%:t"<Enter>
